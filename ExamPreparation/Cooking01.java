...
public class Cooking01 {
    public static void main(String[] args) {
        ...
        ArrayDeque<Integer>ingrediens = new ArrayDeque<>();
        Arrays.stream(scanner.nextLine().split("\\s+"))
                .map(Integer::parseInt)
                .forEach(ingrediens :: push);
        ...
        while (!liquids.isEmpty() && !ingrediens.isEmpty()){
            int lastIngredient = ingrediens.pop();
            ...
            if (cookedFood != null){
                ...
                ingrediens.push(lastIngredient + 3);
        ...
        String remainingIngredients = ingrediens.isEmpty() ? "none" : ingrediens.stream()
                .map(String ::valueOf)
                .collect(Collectors.joining(", "));
